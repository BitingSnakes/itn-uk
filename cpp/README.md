...
When installed, CMake consumers can use `find_package(ukr_itn CONFIG REQUIRED)` and
link `ukr_itn::ukr_itn`. The normalizer is immutable after construction; `Normalize`
